...
import { FoldersEffect } from '@users/materials/data-access'
import { foldersFeatureKey, reducerFolders } from 'libs/users/materials/data-access/src/lib/+state/materials.reducer-folder';
import { materialReducer, materialsFeatureKey } from 'libs/users/materials/data-access/src/lib/+state/materials.reducer';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideStore({
      ...
      [foldersFeatureKey]: reducerFolders,
