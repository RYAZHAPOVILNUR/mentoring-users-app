...
export const appRoutes: Route[] = [
  {
    ...
    children: [
        ...
        children: [
          {
            path: 'users',
            loadComponent: () =>
              import('@users/feature-users-list').then(
          ...
          },
          {
            path: 'users/:id',
            loadComponent: () =>
              import('@users/feature-users-detail').then(
                (c) => c.UsersDetailComponent
              ),
          },
        ],
      },
      {
        path: 'profile',
        loadComponent: () =>
          import('@users/users/profile/feature-profile').then(
      ...
      {
        path: 'materials',
        loadComponent: () => import('@users/feature-materials-folder').then(c => c.MaterialFolderContainerComponent),
      },
      {
        path: 'materials/:id',
        loadComponent: () => import('@users/feature-materials').then(c => c.FeatureMaterialsContainerComponent)
      },
      {
        path: 'articles',
        loadComponent: () =>
          import('@users/users/articles/articles').then(
            (c) => c.ArticlesViewContainerComponent
          ),
      },
      {
        path: 'articles/:id',
        loadComponent: () =>
          import('@users/users/articles/article-read').then(
            (c) => c.ArticleReadContainerComponent
          ),
      },
      {
        path: 'tasks',
  ...
  },
  {
    path: 'login',
    loadComponent: () =>
      import('@auth/feature-login').then((c) => c.LoginContainerComponent),
  },
  {
    path: 'signup',
    loadComponent: () =>
      import('@auth/feature-register').then(
