...
export const appRoutes: Route[] = [
  {
    ...
    children: [
      ...
      {
        path: 'materials',
        loadComponent: () => import('@users/folder-list').then((c) => c.FolderListContainerComponent),
      },
      {
        path: 'materials/:id',
        loadComponent: () => import('@users/material-list').then((c) => c.MaterialListContainerComponent),
      },
      {
        path: 'articles',
