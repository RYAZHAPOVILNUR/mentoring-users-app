...
export const appRoutes: Route[] = [
  {
    ...
    children: [
      ...
      {
        path: 'materials',
        loadComponent: () => import('@users/materials/folder-list').then(c => c.FoldersListContainerComponent),
      },
      {
        path: 'materials/:id',
        loadComponent: () => import('@users/materials/materials-list').then(c => c.MaterialsListContainerComponent),
      },
      {
        path: 'articles',
        loadComponent: () =>
