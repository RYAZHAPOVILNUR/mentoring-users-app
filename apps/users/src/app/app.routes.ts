...
export const appRoutes: Route[] = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'materials',
        loadComponent: () =>
          import('@users/users/materials/feature-folders-list').then((c) => c.FoldersListContainerComponent),
      },

      {
        path: 'materials/:id',
        loadComponent: () => import('@users/feature-materials-list').then((c) => c.MaterialsListComponent),
      },
