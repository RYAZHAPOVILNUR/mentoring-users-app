...
export const appRoutes: Route[] = [
  ...
  {
    path: 'home',
    loadComponent: () => import('@users/home').then(c => c.HomeComponent),canActivate:[authGuard]
  },
  {
    path: 'users/:id',
    loadComponent: () => import('@users/feature-users-detail').then(c => c.UsersDetailComponent),canActivate:[authGuard]
  },
  {
    path: 'login',
