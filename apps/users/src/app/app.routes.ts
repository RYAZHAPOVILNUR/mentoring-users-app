...
export const appRoutes: Route[] = [
  {
    ...
    children: [
      ...
      {
        path: 'materials',
        loadComponent: () => import('@users/users/materials/feature-folders-list').then((c) => c.FoldersListContainerComponent),
      },
      {
        path: 'materials/:id',
        loadComponent: () => import('@users/users/materials/feature-materials-list').then((c) => c.MaterialsListContainerComponent),
      },
      {
        path: 'articles',
