...
export class DetailUsersCardComponent implements OnInit {
  ...
  // public totalStoryPoints: FormControl = new FormControl({ value: this.vm.user?.totalStoryPoints, disabled: true });

  @Output() editUser = new EventEmitter<{
    user: CreateUserDTO;
    onSuccessCb: onSuccessEditionCbType;
  }>();
  // @Output() addStoryPoint = new EventEmitter<{ user: CreateUserDTO; onSuccessAddSP: onSuccessEditionCbType }>();
  ...
  // private setStoryPoint(isAdmin: boolean) {
  //   isAdmin ? this.totalStoryPoints.enable() : this.totalStoryPoints.disable();
  // }
  ...
  // private onAddSPSuccess: onSuccessStoryPointCbType = () =>
