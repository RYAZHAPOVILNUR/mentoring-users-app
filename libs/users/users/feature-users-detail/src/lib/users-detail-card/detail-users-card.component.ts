...
import { onSuccessEditionCbType, onSuccessSPCbType } from '@users/users/data-access';
...
export class DetailUsersCardComponent implements OnInit {
  ...
  private onAddStoryPointsSuccess: onSuccessSPCbType = () => 
    this.snackbarStoryPoints.openFromTemplate(this.snackbarStoryPointsTemplateRef, {
      duration: 2500,
      horizontalPosition: 'center',
      verticalPosition: 'top',
    })
