...
export class DetailUsersCardComponent implements OnInit {
  ...
  public totalStoryPoints: FormControl = new FormControl <number | null >({ value: null, disabled: !this.vm.editMode})
  ...
  public onAddStoryPoint() {
    ...
    this.addStoryPoints.emit({
      ...
      onSuccessAddSP: this.onEditSPSuccess,
    });
  ...
  @ViewChild('snackbar') snackbarTemplateRefSP!: TemplateRef<any>;
  ...
  private onEditSPSuccess: onSuccessSPonCbType = () =>
    this.snackBar.openFromTemplate(this.snackbarTemplateRef, {
      duration: 2500,
      horizontalPosition: 'center',
      verticalPosition: 'top',
