...
import { UsersErrors, UsersFacade, onSuccessEditionCbType, onSuccessStoryPointType } from '@users/users/data-access';
...
export class UsersDetailComponent {
  ...
  onAddStoryPoints(userData: CreateUserDTO, onSuccessAddStoryPoint: onSuccessStoryPointType) {
    this.usersFacade.addStoryPoints(userData, this.user.id, onSuccessAddStoryPoint)
  }
}
