...
export class UsersDetailComponent {
  ...
  public onEditStoryPoints(userData: Partial<CreateUserDTO>, onSuccessCb: onSuccessEditionCbType) {
    this.usersFacade.editUserStoryPoints(userData, this.user.id, onSuccessCb);
  }
