...
export class UsersDetailComponent {
  ...
  public onAddUserStoryPoint(userData: CreateUserDTO, onAddStoryPointsSuccess: onSuccessStoryPointsCbType) {
    this.usersFacade.addUserStoryPoints(userData, this.user.id, onAddStoryPointsSuccess);
  }
