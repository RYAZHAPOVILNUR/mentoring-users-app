...
export class UsersDetailComponent {
  ...
  onAddStoryPoints(userData: CreateUserDTO, onSuccessSPonCbType: onSuccessSPonCbType){
    this.usersFacade.addStoryPoints(userData, this.user.id, onSuccessSPonCbType)
  }
  onCloseUser() {
