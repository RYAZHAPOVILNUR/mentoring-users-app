...
export class UsersDetailComponent {
  ...
  public onAddStoryPoints(userData: CreateUserDTO, onAddSPSuccess: onSuccessEditionCbType) {
    this.usersFacade.addStoryPoints(userData, this.user.id, onAddSPSuccess)
  }
  onDeleteUser() {
