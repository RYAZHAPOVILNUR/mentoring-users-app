...
import { UsersErrors, UsersFacade, onSuccessEditionCbType, onSuccessPonCbType } from '@users/users/data-access';
...
export class UsersDetailComponent {
  ...
  onAddStoryPoints(userData: CreateUserDTO, onSuccessAddSP: onSuccessPonCbType) {
    this.usersFacade.addStoryPointsToUser(userData, this.user.id, onSuccessAddSP);
  }
}
