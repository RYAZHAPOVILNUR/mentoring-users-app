...
import { UsersErrors, UsersFacade, onSuccessEditionCbType, onSuccessAddSP } from '@users/users/data-access';
...
export class UsersDetailComponent {
  ...
  onAddUserStoryPoints(userData: {userStoryPoints: number, onSuccessAddSP: onSuccessAddSP}) {
    this.usersFacade.addUserStoryPoints({...userData, id: Number(this.user.id)})
  }
}
