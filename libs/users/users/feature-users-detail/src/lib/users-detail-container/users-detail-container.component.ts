...
import { UsersErrors, UsersFacade, onSuccessEditionCbType, onSuccessStoryPointsType } from '@users/users/data-access';
...
export class UsersDetailComponent {
  ...
  onAddStoryPoints(userData: CreateUserDTO, onSuccessAddStoryPoints: onSuccessStoryPointsType) {
