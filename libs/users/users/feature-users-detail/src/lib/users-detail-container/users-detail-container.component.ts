...
import { UsersErrors, UsersFacade, onSuccessEditionCbType, onSuccessSPCbType } from '@users/users/data-access';
...
export class UsersDetailComponent {
  ...
  public onEditUserStoryPoints(userData: CreateUserDTO, onSuccessAddStoryPoints: onSuccessSPCbType) {
    this.usersFacade.editUserStoryPoints(userData, this.user.id, onSuccessAddStoryPoints);
    this.router.navigate(['/admin/users/', this.user.id])
  }
