...
export class UsersDetailComponent {
  ...
  public onEditTotalStoryPointsUser(userData: CreateUserDTO, onSuccessCb: onSuccessEditionCbType) {
    this.usersFacade.editUserTotalStoryPoint(userData, this.user.id, onSuccessCb);
  }
