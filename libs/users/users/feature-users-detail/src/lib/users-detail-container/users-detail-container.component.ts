...
export class UsersDetailComponent {
  ...
  public onEditStoryPoints(userData: CreateUserDTO, onSuccessStoryPoints: onSuccessStoryPointsCbType) {
    this.usersFacade.editStoryPoints(userData, this.user.id, onSuccessStoryPoints); // отправляет метод editStoryPoints в фасад
    // console.log('container',userData, this.user.id)
  }
