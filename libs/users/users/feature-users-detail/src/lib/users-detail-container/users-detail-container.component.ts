...
export class UsersDetailComponent {
  ...
  public onEditUserStoryPoints(user: CreateUserDTO, onSuccessCbStoryPoints: onSuccessStoryPointCbType) {
    this.usersFacade.editUserStoryPointsFacade(user, this.user.id, onSuccessCbStoryPoints);
  }
