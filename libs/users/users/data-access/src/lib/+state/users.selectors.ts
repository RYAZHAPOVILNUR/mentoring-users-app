...
export const filteredUsers = createSelector(selectAllUsers, selectUsersFilter, (allUsers: UsersEntity[], filterInput) => allUsers.filter(user => user.name.toLowerCase().includes(filterInput.name.toLowerCase()))
