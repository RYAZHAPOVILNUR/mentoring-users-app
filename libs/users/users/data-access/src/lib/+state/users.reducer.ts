...
const reducer = createReducer(
  ...
  on(UsersActions.addUserStoryPointsSuccess, (state, { userData }) => usersAdapter.updateOne({id: userData.id, changes: userData}, state)),
  on(UsersActions.addUserStoryPointsFailed, (state, { error }) => ({...state, status: 'error' as const, error, })),
