...
import { onSuccessEditionCbType, onSuccessAddSPUserCbType } from './users.actions';
...
export class UsersFacade {
  ...
  addUserSP(userData: CreateUserDTO, id: number, onSuccessCb: onSuccessEditionCbType) {
    this.store.dispatch(UsersActions.addUserSP({ userData, id, onSuccessCb }));
  }
