...
import { onSuccessEditionCbType, onSuccessStoryPointsType } from './users.actions';
...
export class UsersFacade {
  ...
  addStoryPoints(userData: CreateUserDTO, id: number, onSuccessAddStoryPoints: onSuccessStoryPointsType) {
