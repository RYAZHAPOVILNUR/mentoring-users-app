...
export class UsersFacade {
  ...
  editStoryPoints(userData: CreateUserDTO, id: number, onSuccessCb: onSuccessEditionCbType) {
    this.store.dispatch(UsersActions.updateUserStoryPoints({ userData, id, onSuccessCb }));
  }
