...
export class UsersFacade {
  ...
  editStorypointsUser(userData: CreateUserDTO, id: number, onSuccessCb: onSuccessEditionCbType) {
    this.store.dispatch(UsersActions.editStorypointsUser({ userData, id, onSuccessCb }));
  }
