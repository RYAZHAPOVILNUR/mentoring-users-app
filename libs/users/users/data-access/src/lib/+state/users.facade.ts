...
import { Cb } from './users.actions.types';
...
export class UsersFacade {
  ...
  editUser(userData: CreateUserDTO, id: number, onSuccessCb: Cb) {
    this.store.dispatch(UsersActions.editUser({ userData, id, onSuccessCb }));
  }

  addStoryPoints(userData: CreateUserDTO, id: number, onSuccessCb: Cb) {
