...
export class UsersFacade {
  ...
  addStoryPoints(userData: CreateUserDTO, id: number): void {
    console.log('addStoryPoints facade', userData, id);
    this.store.dispatch(UsersActions.addUserStoryPoints({ userData, id }));
  }
