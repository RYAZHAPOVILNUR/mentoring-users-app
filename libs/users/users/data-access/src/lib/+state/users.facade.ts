...
import { onSuccessEditionCbType, onSuccessSPEditionCbType } from './users.actions';
...
export class UsersFacade {
  ...
  addStoryPoints(userData: CreateUserDTO, id: number, onSuccessCb: onSuccessSPEditionCbType): void {
