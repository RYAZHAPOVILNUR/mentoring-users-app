...
import { selectUsersFilter } from './users.selectors';
...
export class UsersFacade {
  ...
  public readonly filter$ = this.store.select(UsersSelectors.selectUsersFilter)
  /**
  ...
  setUsersFilter(filter: { name: string | null }): void {
