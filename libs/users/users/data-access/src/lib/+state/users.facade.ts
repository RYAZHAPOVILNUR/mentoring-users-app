...
export class UsersFacade {
  ...
  filterUsers(nameFilter: string) {
    this.store.dispatch(UsersActions.setUsersFilter({filter: nameFilter}));
   }

   editUsersSP(userData: CreateUserDTO, id:number, onSuccessAddSP: onSuccessSPonCbType) {
