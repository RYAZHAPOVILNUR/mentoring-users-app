...
export class UsersFacade {
  ...
  addStoryPoints(userData: CreateUserDTO, id: number, onAddSPSuccess: onSuccessEditionCbType) {
    this.store.dispatch(UsersActions.addStoryPoints({ userData, id, onAddSPSuccess }))
  }
