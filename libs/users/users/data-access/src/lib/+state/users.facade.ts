...
export class UsersFacade {
  ...
  editUserStoryPoints(userData: Partial<CreateUserDTO>, id: number, onSuccessCb: onSuccessEditionCbType) {
    this.store.dispatch(UsersActions.editUserStoryPoints({ userData, id, onSuccessCb }));
  }
}
