...
export class UsersFacade {
  ...
  public readonly $filteredUsers$ = this.store.select(
    UsersSelectors.selectFilteredUsers
  );
  public readonly $usersFilters$ = this.store.select(
    UsersSelectors.selectUsersFilters
  );
  ...
  public readonly errors$ = this.store.pipe(
  ...
  setUsersFilter(filter: { usersFilters: UsersFilters }) {
