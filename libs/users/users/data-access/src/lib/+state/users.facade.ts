...
export class UsersFacade {
  ...
  // public readonly addUserSPoint$ = this.store.pipe
  /**
  ...
  addUserSPoint(userData: CreateUserDTO, id: number, onSuccessAddSP: onSuccessSPonCbType) {
    this.store.dispatch(UsersActions.addUserSPoints({ userData, id, onSuccessAddSP }));
  }
}
