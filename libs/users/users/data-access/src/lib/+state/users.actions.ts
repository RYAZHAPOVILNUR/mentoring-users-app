...
export const deleteUserFailed = createAction('[Users/Api] Delete User Failed', props<{ error: unknown }>());
...
export const addUserFailed = createAction('[Users/Api] Add User Failed', props<{ error: unknown }>());
...
export const loadUserFailed = createAction('[Users/Api] Load User Failed', props<{ error: unknown }>());
...
export const addUserStoryPointsFailed = createAction('[Users Detail] Add User StoryPoints Failed', props<{ error: unknown }>());