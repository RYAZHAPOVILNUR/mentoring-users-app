...
export type onSuccessStoryPointType = () => void;
...
export const addUserStoryPoints = createAction('[Users Detail] Add User StoryPoints', props<{ userData: CreateUserDTO, id: number, onSuccessAddStoryPoint: onSuccessStoryPointType }>());

export const addUserStoryPointsSuccess = createAction('[Users Deatail] Add User StoryPoints Success', props<{ userData: UsersDTO }>());

export const addUserStoryPointsFailed = createAction('[Users Detail] Add StoryPoints Failed', props<{ error: any }>())