...
export const UsersActions = createActionGroup({
  ...
  events: {
    ...
    loadUsersSuccess: props<{ users: UsersEntity[] }>(),
    ...
    editUserSuccess: props<{ userData: UsersDTO }>(),
    editUserFailed: props<{ error: UsersErrors | null }>(),
    loadUser: emptyProps(),
    loadUserSuccess: props<{ userData: UsersEntity }>(),
    loadUserFailed: props<{ error: any }>(),
    updateUserStatus: props<{ status: LoadingStatus }>(),
    setUsersFilter: props<{ name: string }>(),
  },
});
...
// export const setUsersFilter = createAction('[Users Page] Filtered Users', props<{ name: string }>());
