...
export const addUserStoryPoints = createAction('[Users Detail] Add User StoryPoints', props<{ userData:CreateUserDTO,  id: number, onSuccessCb: onSuccessEditionCbType }>());
