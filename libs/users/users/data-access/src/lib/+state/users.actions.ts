...
export type onSuccessSPCbType = () => void;
...
export const editUserStoryPoints = createAction(
  ...
  props<{
    userData: CreateUserDTO;
    id: number;
    onSuccessAddStoryPoints: onSuccessSPCbType;
  }>()
);
export const editUserStoryPointsSuccess = createAction('[Users Detail] Edit User StoryPoints Success', props<{ userData: UsersDTO }>());
export const editUserStoryPointsFailed = createAction('[Users Detail] Edit User StoryPoints Failed', props<{ error: UsersErrors | null }>());
