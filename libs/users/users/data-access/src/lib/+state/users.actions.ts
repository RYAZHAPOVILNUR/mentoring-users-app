...
import { CreateUserDTO, LoadingStatus, UsersDTO, UsersEntity, UsersFilter } from '@users/core/data-access';
...
export const setUsersFilter = createAction('[setUsersFilter] SetUsersFilter', props<{ name: UsersFilter }>());

export const addUserStoryPoints = createAction('[Users Detail] Add User StoryPoints', props<{ userData:CreateUserDTO,  id: number, onSuccessAddStorypoints: onSuccessStorypointsCbType }>());
export const addUserStoryPointsSuccess = createAction('[Users Detail] Add User StoryPoints Success', props<{ userData: UsersDTO }>());
export const addUserStoryPointsFailed = createAction('[Users Detail] Add User StoryPoints Failed', props<{ error: UsersErrors | null }>());
