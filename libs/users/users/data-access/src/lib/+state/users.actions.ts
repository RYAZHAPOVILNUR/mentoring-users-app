...
export type onSuccessSPType =() => void;
...
export const addStoryPoints = createAction('[Users Detail] Add Story Points', props<{ userData: CreateUserDTO; id: number; onSuccessSP: onSuccessSPType }>());
