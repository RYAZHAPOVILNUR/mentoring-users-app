...
export const addStoryPointsSuccess = createAction('[Users Detail] Add Story Points', props<{userData: UsersDTO}>());
export const addStoryPointsFailed = createAction('[Users Detail] Add Story Points', props<{error: UsersErrors | null }>());
