...
export const loadMaterialsSuccess = createAction('[Materials/API] Load Materialss Success', props<{ materials: IMaterial[] }>());
export const loadMaterialsFailure = createAction('[Materials/API] Load Materialss Failure', props<{ error: AppError }>());
...
export const deleteMaterialFailed = createAction('[Materials/Api] Delete Material Failed', props<{ error: AppError }>());

export const addMaterial = createAction('[Materials Page] Add Material', props<{ materialData:IAddMaterial }>());
export const addMaterialSuccess = createAction('[Materials/Api] Add Material Success', props<{ materials: IMaterial }>());
