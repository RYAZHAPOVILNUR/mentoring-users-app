...
export const openFolders = createAction('[Folders] Open Folders', emptyProps);
export const openFoldersSuccess = createAction('[Folders] Open Folders Success', props<{ folder: Folder }>());
export const openFoldersFailure = createAction('[Folders] Open Folders Failure', props<{ error: any }>());
