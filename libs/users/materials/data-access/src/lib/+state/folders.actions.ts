...
export const loadFoldersSuccess = createAction('[Folders/API] Load Folders Success', props<{ folders: FoldersModel[] }>());
...
export const addFolder = createAction('[Folders Page] Add Folder', props<FoldersSecondModel>());
export const addFolderSuccess = createAction('[Folders/Api] Add Folder Success', props<{ folder: FoldersModel }>());
