...
export const selectOpenedFolderTitle = createSelector(selectOpenedFolder, (folder) => folder?.title ?? null);
export const selectOpenedFolderId = createSelector(selectOpenedFolder, (folder) => folder?.id ?? null);
