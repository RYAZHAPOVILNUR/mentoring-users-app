...
} from 'libs/users/materials/feature-materials-list/src/lib/materials-list/materials-list.component';
...
export class MaterialsListContainerComponent implements OnInit {
  ...
  materials$ = this.materialsFacade.getMaterialsByFolder(this.folder_id);
